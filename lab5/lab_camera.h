    ...
    class Camera
    {
     public:
        ...
        void TranslateRight(float distance)
        {
            ...
            glm::vec3 dir = glm::normalize(glm::vec3(right.x, 0, right.y));
            position += dir * distance;
        }
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 myVec = glm::vec4(forward, 1.0f);
            /* in loc de right - glm3 (0,1,0)*/
            ...
            */
            forward = glm::vec3(glm::rotate(glm::mat4(1.0f), angle, right) * myVec);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 myVec = glm::vec4(forward, 1.0f);
            forward = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * myVec;
            forward = glm::normalize(forward);

            myVec = glm::vec4(right, 1.0f);
            right = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * myVec;
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 myVec = glm::vec4(up, 1.0f);
            up = glm::rotate(glm::mat4(1.0f), angle, forward) * myVec;
